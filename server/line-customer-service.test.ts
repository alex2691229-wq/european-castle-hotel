...
describe('LINE Customer Service Integration - LINE 客服集成', () => {
  ...
  describe('訂房追蹤頁面 LINE 客服入口', () => {
    it('應該在追蹤頁面顯示 LINE 客服提示', () => {
      const tip = '需要協助？';
      expect(tip).toContain('協助');
    });

    it('應該提示客戶可以透過 LINE 聯繫', () => {
