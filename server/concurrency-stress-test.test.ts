...
describe("壓力測試和並發測試", () => {
  describe("並發訂房請求", () => {
    ...
    it.skip("應該處理 100 個並發訂房請求", async () => {
    ...
    it.skip("應該處理 1000 個並發訂房請求", async () => {
