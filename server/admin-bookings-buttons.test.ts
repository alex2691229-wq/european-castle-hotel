...
describe("訂單管理按鈕功能", () => {
  ...
  // 按鈕顯示邏輯測試
  describe("按鈕顯示邏輯", () => {
    it.skip("待確認和已確認狀態應顯示「添加付款信息」按鈕", () => {
  ...
  describe("超期警告", () => {
    ...
    it.skip("超期警告只應在待確認、已確認、已匯款狀態顯示", () => {
  ...
  describe("訂單卡片展開功能", () => {
    ...
    it.skip("展開時應顯示完整的客戶信息", () => {
      const isExpanded = true;
      expect(isExpanded).toBe(true);
    });

    it.skip("展開時應顯示完整的訂房信息", () => {
      const isExpanded = true;
      expect(isExpanded).toBe(true);
    });

    it.skip("展開時應顯示完整的付款信息", () => {
      const isExpanded = true;
      expect(isExpanded).toBe(true);
    });
