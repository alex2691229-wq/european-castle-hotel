...
## 🔴 /admin 頁面 API 連接錯誤修復（2026/01/19 - 用戶報告）

### 錯誤列表
- [ ] TRPC API Query Failed to fetch
- [ ] TRPC API Mutation Failed to fetch
- [ ] Vite WebSocket HMR 連接失敗

### 修復計畫
- [ ] 診斷 TRPC 客戶端配置
- [ ] 檢查 TRPC 後端路由
- [ ] 修復 Vite HMR WebSocket 配置
- [ ] 測試 TRPC 連接
- [ ] 驗證後台管理系統功能


## 🔴 後台管理介面深度修復（2026/01/19 - 用戶需求）
